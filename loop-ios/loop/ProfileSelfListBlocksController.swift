//
//  ProfileSelfListBlocksController.swift
//  loop
//
//  Created by Yecol Hsu on 17/04/2017.
...
class ProfileSelfListBlocksController: UITableViewController, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.title = "kTitle_MyBlockedUsers".localized;
    ...
    func refresh(type: RefreshType) {
        ...
        DataModelManager.sharedInstance.cloudGetBlockedUserList(limit: kDefaultUserNumPerPage, skip: offset,
    ...
    func title(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        let emptyText = "kEmptyBlockedUsers".localized;
