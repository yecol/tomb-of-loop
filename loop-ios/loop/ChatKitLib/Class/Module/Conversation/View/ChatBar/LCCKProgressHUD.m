...
- (void)show {
    self.angle = 0.0f;
    self.seconds = 0;
    self.subTitleLabel.text = @"Swipe up to cancel";
...
- (void)setProgressState:(LCCKProgressState)progressState {
    switch (progressState) {
        case LCCKProgressSuccess:
            self.centerLabel.text = @"record successfully";
            break;
        case LCCKProgressShort:
            self.centerLabel.text = @"too short, please retry";
            break;
        case LCCKProgressError:
            self.centerLabel.text = @"record failed";
            break;
...
- (UILabel *)subTitleLabel{
    if (!_subTitleLabel) {
        ...
        _subTitleLabel.text = @"swipe up to cancel";
