...
- (NSArray<Class> *)sortedInputViewPluginArray {
    ...
    NSArray<NSDictionary *> *notSortedDefaultInputViewPlugin = [inputViewPluginDictArray filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"(LCCKInputViewPluginTypeKey == -1) || (LCCKInputViewPluginTypeKey == -2)"]];
