...
- (void)cancelRecordVoice {
    [LCCKProgressHUD dismissWithMessage:@"Cancel"];
...
- (void)updateCancelRecordVoice {
    [LCCKProgressHUD changeSubTitle:@"Release to cancel"];
}
...
- (void)updateContinueRecordVoice {
    [LCCKProgressHUD changeSubTitle:@"Swipe up to cancel"];
}
...
- (UIButton *)voiceRecordButton {
    if (!_voiceRecordButton) {
        ...
        [_voiceRecordButton setTitle:@"Tap to talk" forState:UIControlStateNormal];
        [_voiceRecordButton setTitle:@"Release to send" forState:UIControlStateHighlighted];
