...
static CGFloat const LCCKAvatarToMessageContent = 6.f;
...
- (void)addGeneralView {
    ...
    self.avatarImageView.layer.borderColor = CL_GREY_BORDER_6C.CGColor;
    self.avatarImageView.layer.borderWidth = 1;
    self.avatarImageView.layer.cornerRadius = kAvatarImageViewWidth/2;
